...
export default {
  ...
  'priv.confirmPin': 'Confirm PIN',
  'priv.min4': 'Use at least 4 digits.',
  'priv.noMatch': 'The two entries don’t match.',
  'priv.setOpen': 'Set PIN & open',
  'priv.pinExplain': 'This is the one and only PIN. It’s stored as a salted hash on this device. Never in plain text, never in the cloud. There is no change or reset. The only way to clear it is Settings → Reset everything, which wipes all app data. So pick one you won’t forget.',
  'priv.title': 'Private log',
  'priv.enterPin': 'Enter your PIN.',
  'priv.pin': 'PIN',
  'priv.unlock': 'Unlock',
  'priv.incorrect': 'Incorrect. {n} left.',
  'priv.tooMany': 'Too many attempts. Locked for 1 hour.',
  'priv.lockedSub': 'Temporarily locked.',
  'priv.tooManyTitle': 'Too many attempts',
  'priv.lockedFor': 'Locked for another {n} min.',
  'priv.onlyReset': 'The only reset is wiping all app data in Settings.',
  'priv.attemptsLeft': '{n} left before a 1-hour lock.',
  'priv.dashSub': 'Neutral ground. Log it, ride it out, move on.',
  'priv.lock': 'Lock 🔒',
  'priv.tabTimer': 'Ride the wave',
  'priv.tabLog': 'Log a moment',
  'priv.tabStats': 'Patterns',
  'priv.waveSurvived': 'Wave survived.',
  'priv.waveSurvivedSub': 'You outlasted it. That’s a rep for the person you’re becoming.',
  'priv.done': 'Done',
  'priv.urgesPass': 'Urges peak and pass, usually within 20 minutes. Start the timer and let it crest.',
  'priv.rideWave': 'Ride the wave',
  'priv.twentyMin': '20 minutes. One at a time.',
  'priv.loggedNoShame': 'Logged. No shame. Noticing is data. Come back anytime.',
  'priv.urgePassed': 'The urge passed',
  'priv.slipped': 'I slipped',
  'priv.when': 'When',
  'priv.trigger': 'Trigger',
  'priv.trig.app': 'app',
  'priv.trig.boredom': 'boredom',
  'priv.trig.lateNight': 'late night',
  'priv.trig.mood': 'mood',
  'priv.trig.other': 'other',
  'priv.trig.urge': 'urge',
  'priv.notesOpt': 'Notes (optional)',
  'priv.notesPh': 'What was going on? Just the facts.',
  'priv.rodeOutQ': 'Did you ride it out?',
  'priv.yesRode': 'Yes, rode the wave',
  'priv.noSlipped': 'No, slipped',
  'priv.logged': 'Logged ✓',
  'priv.logIt': 'Log it',
  'priv.wavesSurvived': 'waves survived 🌊',
  'priv.daysSinceSlip': 'days since last slip',
  'priv.triggerPatterns': 'Trigger patterns',
  'priv.nothingLogged': 'Nothing logged yet. Insights show up as you record moments. No judgment, just data.',
  'priv.mostSlips': 'Most slips happen',
  'priv.commonTrigger': 'Most common trigger',
  'priv.rodeItOut': 'Rode it out',
  'priv.pctTime': '{n}% of the time',
  'priv.recent': 'Recent',
  'priv.urge.0': 'Urges peak and pass. This one will too.',
  'priv.urge.1': 'Breathe. In for 4, hold for 4, out for 6.',
  'priv.urge.2': '20 pushups. Right now. Move the energy.',
  'priv.urge.3': 'Make wudu. Reset the moment.',
  'priv.urge.4': 'Open the editor. Write one line instead.',
  'priv.urge.5': 'You are not the urge. You are the one watching it.',
  'priv.urge.6': 'Drink a full glass of water. Slowly.',
  'priv.urge.7': 'Step outside. Even for 60 seconds.',
  'priv.urge.8': 'The wave is cresting. Ride it, don’t fight it.',
  'priv.urge.9': 'Every minute you wait, it gets weaker.',
}
