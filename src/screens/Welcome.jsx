 ...
 * language (device-preselected), a short pitch, pick Phase 1 anchors, then a
 * skippable prayer location. Existing devices never reach here.
 */
    ...
    <div className="min-h-[100dvh] flex flex-col px-6 pt-16 pb-10 max-w-md mx-auto animate-rise">
      ...
      {step === 1 && (
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1" />
          <Button variant="primary" className="w-full mt-8 py-3.5" onClick={() => setStep(2)}>{t('ob.getStarted')}</Button>
          <button onClick={() => setStep(0)} className="text-[13px] text-[var(--color-faint)] mt-4">{t('common.back')}</button>
        </div>
      )}
      ...
      {step === 2 && (
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1" />
          <Button variant="primary" className="w-full mt-8 py-3.5" onClick={() => setStep(3)}>{startLabel}</Button>
      ...
      {step === 3 && (
        <div className="flex-1 flex flex-col">
          ...
          <button onClick={() => setStep(2)} className="text-[13px] text-[var(--color-faint)] mt-1">{t('common.back')}</button>
        </div>
      )}
    </div>
  )
